            ...
            <div>
                <div class="topbar-text dropdown d-md-none {{Session::get('direction') === "rtl" ? 'mr-auto' : 'ml-auto'}}">
                    ...
                    <a href="#" class="topbar-link ">
                        <img src="{{asset('public/assets/front-end/img/whatsapp.png')}}" alt="icon" style="width: 27px">
                    </a>

                    <a href="#" class="topbar-link ">
                        <img src="{{asset('public/assets/front-end/img/fb.png')}}" alt="icon" style="width: 23px">
                    </a>

                    <a href="#" class="topbar-link ">
                        <img src="{{asset('public/assets/front-end/img/linkedin.png')}}" alt="icon" style="width: 23px">
                    </a>

                    <a href="#" class="topbar-link ">
                        <img src="{{asset('public/assets/front-end/img/instagram.png')}}" alt="icon" style="width: 23px">
                    </a>
                    <a href="#" class="topbar-link ">
                        <img src="{{asset('public/assets/front-end/img/twitter.png')}}" alt="icon" style="width: 23px">
                    </a>
                </div>
                <div class="d-none d-md-block {{Session::get('direction') === "rtl" ? 'mr-2' : 'mr-2'}} text-nowrap">
                    ...
                    <a href="#" class="topbar-link d-none d-md-inline-block">
                        <img src="{{asset('public/assets/front-end/img/whatsapp.png')}}" alt="icon" style="width: 27px">
                    </a>
                ...
                <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                    ...
                    <div class="navbar-tool dropdown {{Session::get('direction') === "rtl" ? 'mr-md-3' : 'ml-md-3'}}">
                        <a class="navbar-tool-icon-box bg-secondary dropdown-toggle" href="#">
                            <i class="navbar-tool-icon czi-location"></i>
                        </a>
                    </div>
                    <div class="navbar-tool dropdown {{Session::get('direction') === "rtl" ? 'mr-md-3' : 'ml-md-3'}}">
        ...
        <div class="navbar navbar-expand-md navbar-stuck-menu"  >
            <div class="container px-10px">
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    ...
                    <!-- Primary menu-->
                    <ul class="navbar-nav" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}" id="header_nav">
                        ...
                        @endif
                        <li class="nav-item dropdown {{request()->is('/track-order')?'active':''}}">
                            <a class="nav-link" href="{{route('track-order.index')}}">{{ \App\CPU\translate('Track Order')}}</a>
                        </li>
